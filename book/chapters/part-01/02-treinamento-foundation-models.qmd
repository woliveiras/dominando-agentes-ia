...
1. **Auditorias de dados**: Documentar origem e licenças de todos os dados de treinamento
2. **Filtros conservadores**: Na dúvida, remover conteúdo questionável
3. **Modelos defensivos**: Implementar mecanismos anti-memorização
4. **Transparência**: Publicar cards de modelo documentando fontes de dados
