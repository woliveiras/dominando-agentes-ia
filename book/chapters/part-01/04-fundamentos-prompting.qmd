...
::: {.callout-tip title="Instalação"}
Antes de executar os exercícios, instale as dependências:
```bash
...
Os exercícios usam **simulação de LLMs** para permitir execução sem API keys. Para produção:
