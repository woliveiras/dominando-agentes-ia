...
No próximo capítulo, vamos entender como funcionam os embeddings e vetores, a base para recuperação de informação e sistemas RAG (Retrieval-Augmented Generation), que será muito explorado na segunda parte do livro.